...
- Set packFolders to put all compendiums in a CRYS BORG folder.
...
- Support Foundry v10. Note: crys borg system 2.0.0+ is no longer compatible with Foundry v9.
...
- Made CRYS BORG system compatible with v9.

# 1.1.3

- Fixed character creation "roll d2 for armor if you rolled a scroll".
- Added call to new hook crysborgReady after system is ready.
